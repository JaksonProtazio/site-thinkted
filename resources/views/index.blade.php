				...
				<div id="quemSomos" class="row scroll">
					<div class="escurecer">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 paddingQuemSomos" id="innerQuemSomos">
							...
							<h3 class="subtitulos anime" data-anime="left">Laboratório de Pesquisa e Desenvolvimento em Tecnologias Educacionais</h3>
							...
							<div id="esconderTexto" class="anime" data-anime="right">
						      	<p id="resumoQuemSomos" class="text-justify"> O ThinkTEd - Laboratório de Pesquisa e Desenvolvimento em Tecnologias Educacionais - Voltado para o estudo e desenvolvimento de Objetos e Processos de Aprendizagem. Localiza-se nas dependências do GRAEST - Grupo de Robótica e Automação da UEA/EST. </p>
